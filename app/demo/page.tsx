  ...
  return (
    <div className="relative isolate min-h-screen overflow-hidden">
      ...
      <header className="flex h-16 items-center justify-between px-6 lg:px-10">
        <Link href="/" className="flex items-center gap-2 text-[12.5px] text-ink-muted hover:text-ink">
      ...
      <main className="mx-auto flex max-w-[1180px] flex-col items-center px-6 pb-16 pt-6 lg:pt-14">
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          <h1 className="max-w-3xl font-serif text-[44px] font-medium leading-[1.02] tracking-tight text-ink sm:text-[64px]">
            Pentru următoarele 2 minute,{" "}
            <span className="relative inline-block">
              <span className="relative z-10">ești Maria.</span>
          ...
          <p className="max-w-2xl text-[16px] leading-relaxed text-ink-muted sm:text-[17px]">
            <span className="font-medium text-ink">Maria Popescu</span>, expert contabil CECCAR cu 47 de clienți în Cluj.
            Astăzi e <strong className="text-ink">27 aprilie 2026</strong>, mai sunt <strong className="text-ink">4 zile</strong>{" "}
            până la termenul limită al declarațiilor, iar închiderea ți-a luat mereu 3–5 zile. Hai să-ți arătăm
            cum ContaFlow reduce totul la câteva ore.
          </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[12px] text-ink-subtle">
          ...
          {["Saga", "WinMentor", "Ciel", "SmartBill Conta", "SPV ANAF", "D406 SAF-T"].map((label, i) => (
            <span key={label} className="font-serif text-[14px] italic text-ink-muted">
